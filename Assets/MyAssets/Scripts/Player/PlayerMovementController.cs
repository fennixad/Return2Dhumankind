using MyAssets.Scripts.Planets;
using UnityEngine;
...
namespace MyAssets.Scripts.Player
{
    ...
    */
        ...
        private void HandleMovement()
        {
            ...
            // Si estás en el suelo y no estás intentando saltar ni usar jetpack, limpiamos posibles rebotes. No funciona bien porque
            // si el personaje está cayendo y pulsas espacio y justo se empieza a elevar y toca el suelo, salta pero reiniciando la fuerza de caída.
